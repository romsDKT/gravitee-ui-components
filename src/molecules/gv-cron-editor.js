...
export class GvCronEditor extends withResizeObserver(InputElement(LitElement)) {
  ...
  constructor () {
    ...
    this._modes = ['seconds', 'minutes', 'hourly', 'daily', 'weekly', 'monthly', 'yearly', 'expert'];
  ...
  onResize ({ width }) {
    ...
    this._small = width < 450;
  }

  set value (value) {
    if (isValidCron(value, { seconds: true, alias: true })) {
      this._value = value;
      if (this._state.expert.value === '') {
        this._state.expert.value = value;
      }
    }
  }
  ...
  get value () {
    if (this.mode === 'expert') {
      return this._state.expert.value;
    }
    return this._value;
  }
  ...
  _onChangeTab (event) {
    ...
    this.generate();
    if (this.mode === 'expert') {
      this.shadowRoot.querySelector('#expert-input').focus();
    }
  }
  ...
  generate () {
    ...
    switch (this.mode) {
      ...
      case 'yearly':
        ...
        break;
      case 'expert':
        tmpValue = this._state.expert.value;
        break;
      default:
    ...
    return html`<div>
                  ...
                  <div class="box">
                   ...
                   <div slot="title" class="generated-expression">
                      <gv-input name="expert.value" 
                                ?readonly="${this.mode !== 'expert'}"
                                autofocus
                                .value="${this.value}" 
                                id="expert-input"
                   ...
                   <div slot="content" id="expert" class="tab-content tab-content_expert">
                      <div>
  ...
  static get styles () {
    return [
      ...
      css`
        ...
        .tab-content_expert small,
        .tab-content_expert gv-icon {
          margin: 0 0.2rem;
        }
